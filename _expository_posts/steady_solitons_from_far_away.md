...
<ul>
<li>$\lim _{d(x, o) \rightarrow \infty} R(x)=0$;</li>
<li>$\lim _{d(x, o) \rightarrow \infty} R(x) d(x, \Gamma)=0$;</li>
<li>the asymptotic cone of $(M, g)$ is a ray.</li>
</ul>
</div>
...
<div class="theorem" id="theorem-26">
